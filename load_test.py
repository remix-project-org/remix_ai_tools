...
class QuickstartUser(HttpUser):
    ...
    def test_code_generation(self):
        self.client.post( "https://l70m88pijz3d0h-7860.proxy.runpod.net/ai/api/code_generation", 
        json=json.dumps({
            "context_code":"// SPDX-License-Identifier: GPL-3.0\n pragma solidity >=0.8.2 <0.9.0;\n\n\ncontract Storage {\n\n    uint256 number; \n\n    ///write a function for adding 2 uint256 numbers and return the result",
            "comment":""
        }))
...
#         self.client.post( "https://l70m88pijz3d0h-7860.proxy.runpod.net/ai/api/code_explaining", 
#         json=json.dumps({
...
#         self.client.post( "https://l70m88pijz3d0h-7860.proxy.runpod.net/ai/api/error_explaining", 
#         json=json.dumps({
...
#         self.client.post( "https://l70m88pijz3d0h-7860.proxy.runpod.net/ai/api/contract_generation", 
#         json=json.dumps({
...
#         self.client.post( "https://l70m88pijz3d0h-7860.proxy.runpod.net/ai/api/answering", 
#         json=json.dumps({
