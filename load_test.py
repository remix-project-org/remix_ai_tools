...
class QuickstartUser(HttpUser):
    ...
    def test_code_completion(self):
        self.client.post( "https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/code_completion", 
        json={
    ...
    def test_code_explaining(self):
        self.client.post( "https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/code_explaining", 
        json=json.dumps({
            "context_code":"// SPDX-License-Identifier: GPL-3.0\n pragma solidity >=0.8.2 <0.9.0;\n\n/**\n * @title Storage\n * @dev Store & retrieve value in a variable\n * @custom:dev-run-script ./scripts/deploy_with_ethers.ts\n */\ncontract Storage {\n\n    uint256 number;",
        }))
    ...
    def test_error_explaining(self):
        self.client.post( "https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/error_explaining", 
        json=json.dumps({
    ...
    def test_contract_generation(self):
        self.client.post( "https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/contract_generation", 
        json=json.dumps({
    ...
    def test_answering(self):
        self.client.post( "https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/answering", 
        json=json.dumps({
...
x = requests.post(url="https://hkfll35zthu6e2-7860.proxy.runpod.net/ai/api/code_completion", 
        json={
            "context_code":"// SPDX-License-Identifier: GPL-3.0\n pragma solidity >=0.8.2 <0.9.0;\n\n/**\n * @title Storage\n * @dev Store & retrieve value in a variable\n * @custom:dev-run-script ./scripts/deploy_with_ethers.ts\n */\ncontract Storage {\n\n    uint256 number;",
            "comment":"",
            "max_new_tokens":10
